...
<body class="hold-transition layout-top-nav layout-navbar-fixed">
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-header  d-flex p-0">
                                    ...
                                    <div class="ml-auto mr-3 p-2">
                                        ...
                                        <a href="<?= site_url('admin/Eskul/Cetak') ?>" class="btn btn-warning" target="_blank" rel="noopener noreferrer"><i class="fas fa-print"></i>Cetak</a>
                                    </div>
    ...
    <script>
        $(function() {
            ...
            const config_table = {
                url: '<?= site_url('admin/Eskul/GetData') ?>',
                columns: [{
                        data: 'no',
                        defaultContent: ''
                    },
            ...
            $('#tambah-baru').click(function() {
                ...
                $('#form-input').prop('action', "<?= site_url('admin/Eskul/insert') ?>")
                $('#modaloverlay2').hide();
            });
            ...
            $('#tabel-data').on('click', '#btn-ubah', function() {
                ...
                }, "<?= site_url('admin/Eskul/GetDataByID') ?>", "<?= site_url('admin/Eskul/update') ?>")
            });
            ...
            $('#tabel-data').on('click', '#btn-hapus', function() {
                ...
                hapus_data("<?= site_url('admin/Eskul/delete') ?>", data)
            });
