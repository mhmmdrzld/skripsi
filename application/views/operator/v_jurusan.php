...
<body class="hold-transition layout-top-nav layout-navbar-fixed">
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-header  d-flex p-0">
                                    ...
                                    <div class="ml-auto mr-3 p-2">
                                        ...
                                        <a href="<?= site_url('operator/Jurusan/Cetak') ?>" class="btn btn-warning" target="_blank" rel="noopener noreferrer"><i class="fas fa-print"></i>Cetak</a>
                                    </div>
                            ...
                            <form class="form-horizontal" id="form-input" method="POST">
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="namajurusan" class="form-control form-control-sm">
    ...
    <script>
        $(function() {
            ...
            const config_table = {
                url: '<?= site_url('operator/Jurusan/GetData') ?>',
                columns: [{
                        data: 'no',
                        defaultContent: ''
                    },
            ...
            $('#tambah-baru').click(function() {
                ...
                $('#form-input').prop('action', "<?= site_url('operator/Jurusan/insert') ?>")
                $('#modaloverlay2').hide();
            });
            ...
            $('#tabel-data').on('click', '#btn-ubah', function() {
                ...
                ajax_click(data, function data_ajax(r) {
                    $('input[name="namajurusan"]').val(r.namajurusan);
                    $('input[name="id"]').val(r.id);
                }, "<?= site_url('operator/Jurusan/GetDataByID') ?>", "<?= site_url('operator/Jurusan/update') ?>")
            });
            ...
            $('#tabel-data').on('click', '#btn-hapus', function() {
                ...
                hapus_data("<?= site_url('operator/Jurusan/delete') ?>", data)
            });
