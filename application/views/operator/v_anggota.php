...
<body class="hold-transition layout-top-nav layout-navbar-fixed">
    ...
    <script>
        $(function() {
            ...
            const config_table = {
                url: '<?= site_url('operator/Anggota/GetData') ?>',
                columns: [{
                        data: 'no',
                        defaultContent: ''
                    },
            ...
            $('#tambah-baru').click(function() {
                ...
                $('#form-input').prop('action', "<?= site_url('operator/Anggota/insert') ?>")
                $('#modaloverlay2').hide();
            });
            ...
            $('#tabel-data').on('click', '#btn-ubah', function() {
                ...
                }, "<?= site_url('operator/Anggota/GetDataByID') ?>", "<?= site_url('operator/Anggota/update') ?>")
            });
            ...
            $('#tabel-data').on('click', '#btn-hapus', function() {
                ...
                hapus_data("<?= site_url('operator/Anggota/delete') ?>", data)
            });
