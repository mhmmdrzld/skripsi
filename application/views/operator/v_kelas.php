...
<body class="hold-transition layout-top-nav layout-navbar-fixed">
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-header  d-flex p-0">
                                    ...
                                    <div class="ml-auto mr-3 p-2">
                                        ...
                                        <a href="<?= site_url('operator/Kelas/Cetak') ?>" class="btn btn-warning" target="_blank" rel="noopener noreferrer"><i class="fas fa-print"></i>Cetak</a>
    ...
    <script>
        $(function() {
            ...
            const config_table = {
                url: '<?= site_url('operator/Kelas/GetData') ?>',
                columns: [{
                        data: 'no',
                        defaultContent: ''
                    },
            ...
            $('#tambah-baru').click(function() {
                ...
                $('#form-input').prop('action', "<?= site_url('operator/Kelas/insert') ?>")
                $('#modaloverlay2').hide();
            });
            ...
            $('#tabel-data').on('click', '#btn-ubah', function() {
                ...
                }, "<?= site_url('operator/Kelas/GetDataByID') ?>", "<?= site_url('operator/Kelas/update') ?>")
            });
            ...
            $('#tabel-data').on('click', '#btn-hapus', function() {
                ...
                hapus_data("<?= site_url('operator/Kelas/delete') ?>", data)
            });
