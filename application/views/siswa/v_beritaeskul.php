                            ...
                            <form class=" form-horizontal" id="form-input" method="POST">
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="judulberita" class="form-control form-control-sm" readonly>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="tanggalberita" class="form-control form-control-sm datemask" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Ekstrakurikuler :</label>
                                        <div class="col-sm-5">
                                            <input type="text" name="eskul" class="form-control form-control-sm" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Deskripsi :</label>
                                        <div class="col-sm-9" id="isiberita">
        ...
        $(function() {
            ...
            const config_table = {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(row) {
                            return '<center>' +
                                ' <button id="btn-ubah" class="btn btn-success" data-id="' + row.id + '" data-toggle="tooltip" data-placement="top" title="Tombol Lihat">' +
            ...
            $('#tabel-data').on('click', '#btn-ubah', function() {
                ...
                ajax_click(data, function data_ajax(r) {
                    ...
                    var markup = $('#isiberita').summernote('code', r.isiberita);
                    $('#isiberita').summernote('destroy');

                    $('input[name="judulberita"]').val(r.judulberita);
                    $('input[name="tanggalberita"]').val(Tanggal(r.tanggalberita));
                    $('input[name="id"]').val(r.id);
                    $('input[name="jeniskegiatan"]').val('<?= $jenis ?>');
                    $('input[name="eskul"]').val(r.namaeskul);
                    // $('select[name="ideskul"]').val(r.idkegiatan).trigger('change');

                }, "<?= site_url('siswa/Berita/GetDataByIDSiswa') ?>", "<?= site_url('siswa/Berita/update') ?>")
            });
